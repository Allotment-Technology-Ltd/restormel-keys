...
- **Detected:** 2026-06-18, during interactive setup of the two-stream email system (REC-PLAN-028) in a Claude Code operator session.   **Reported by:** operator/founder.   **Severity:** medium.
