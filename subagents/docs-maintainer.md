...
- docs/working-agreement.md, docs/prompt-governance.md (for what counts as canonical).
...
3. **Governance:** “<file> is used as canonical but not listed in docs/prompts-reference.md; add or reclassify.”
