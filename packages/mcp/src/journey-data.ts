...
const PHASES_ALL: JourneyPhase[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        title: "Rules (routes)",
        detail: "Create routes with ordered steps, optional ingestion workload/stage, publish/rollback.",
        dashboardHref: `${HOST}/keys/dashboard/routes`,
        docsHref: `${HOST}/keys/docs/guides/routing-contract`,
        suggestedMcpTools: [
          "projects.list",
          "routes.list",
      ...
      {
        title: "Test & Preview",
        detail: "Exercise a resolve path before production; use simulate for dry-run step diagnostics.",
        dashboardHref: `${HOST}/keys/dashboard/sandbox`,
        suggestedMcpTools: ["routes.simulate", "routing.capabilities"],
      },
    ],
  },
  {
