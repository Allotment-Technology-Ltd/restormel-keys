import { z } from 'zod';
import { AnalysisPhaseSchema, type AnalysisPhase } from './references.js';
import { GraphEdgeSchema, GraphNodeSchema, type GraphEdge, type GraphNode } from './api.js';
import { SupportedDomainSchema, type SupportedDomain } from './domains.js';
