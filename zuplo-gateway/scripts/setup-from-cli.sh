...
echo "  1. Create an API key consumer (Portal → API Key Service, or ./scripts/create-consumer-and-test.sh)"
echo "  2. Put the consumer key in zuplo-gateway/.env as ZUPLO_CONSUMER_KEY"
echo "  3. Test: ./scripts/test-gateway.sh [GATEWAY_URL]"
