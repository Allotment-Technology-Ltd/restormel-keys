...
Add as Cursor Docs for persistent guidance: **docs/archive/2026-03-build-pack/bootstrap-plan.md** and **docs/reference/bootstrap_prompts.md**. Optionally root **README.md**, **STATUS.md**, **docs/governance/working-agreement.md**.
