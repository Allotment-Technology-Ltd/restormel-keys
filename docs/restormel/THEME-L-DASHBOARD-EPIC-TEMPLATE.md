...
- [ ] **Secrets:** No raw keys in UI or MCP output ([security-baseline.md](../security-baseline.md)); masked prefixes / fingerprints only.
...
3. [ ] Use [`@restormel/keys-tokens`](../../packages/keys-tokens) / design system ([design-system-index.md](../design-system-index.md))
