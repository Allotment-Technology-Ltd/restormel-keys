...
**Status:** Reference (companion to [SUITE-ARCHITECTURE-MIGRATION.md](./SUITE-ARCHITECTURE-MIGRATION.md))  
**Owner:** Allotment Technology Ltd  
**Last reviewed:** 2026-06-01  

Maps SOPHIA implementation paths to target Restormel packages. Use this when opening extraction PRs. **Do not extract without following the [SOPHIA reintegration playbook](./SUITE-ARCHITECTURE-MIGRATION.md#7-sophia-reintegration-playbook).**
