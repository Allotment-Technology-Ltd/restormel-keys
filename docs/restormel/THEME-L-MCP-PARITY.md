...
| `testing.config_validate` | [/testing/docs](https://restormel.dev/testing/docs) — config reference, [oss-consumption.md](../testing/oss-consumption.md) | Restormel Testing hub — YAML/CI context | `POST /api/suite/invoke` + `payload.content` / `format` |
