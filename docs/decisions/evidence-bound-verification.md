...
**Status:** Provisional — **pending review. No implementation has been done.** Supersedes the
implicit definition of "validated" used by the current Connect pipeline; foundation for the
Verified Context roadmap (`docs/verified-context-pivot-roadmap.md`) and for the verified-memory
pivot (P3).
