...
| **Secrets** | **GitHub Actions secrets + host env** | Never commit credentials; follow [security-baseline.md](../governance/security-baseline.md). |
...
- [ ] `AGENTS.md` linking [security-baseline.md](../governance/security-baseline.md) and this doc
...
```text
You are scaffolding a new Restormel product module. Follow the canonical stack in docs/architecture/restormel-module-default-stack.md (in the restormel-keys repo) or the equivalent AGENTS.md in this repo.
...
- [design-system-index.md](../design/design-system-index.md) — tokens and UI contracts
