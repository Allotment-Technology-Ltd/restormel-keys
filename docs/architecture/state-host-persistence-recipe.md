...
You may store **separate** columns (`thread_id`, `tenant_id`, `inserted_at`) for indexing; they are not part of `StateEvent`. Do not put secrets in event bodies—see `docs/governance/security-baseline.md`.
