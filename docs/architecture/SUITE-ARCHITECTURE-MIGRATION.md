...
| **Security** | Maintainer | [security-baseline.md](../governance/security-baseline.md); no secrets; BYOK paths unchanged or improved |
...
| Item | Deliverable |
| --- | --- |
| This plan | `docs/architecture/SUITE-ARCHITECTURE-MIGRATION.md` (canonical) |
...
| Extraction map | `docs/product/CONNECT-EXTRACTION-MAP.md` — module-level sophia → package mapping |
...
Full detail: `docs/product/CONNECT-EXTRACTION-MAP.md` (Phase 0 deliverable).
