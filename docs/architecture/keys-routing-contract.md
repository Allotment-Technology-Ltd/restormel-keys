...
| `modelAttempts`-style forensics | **`traceId`**, **`switchReasonCode`**, simulate **`stepDiagnostics`** | Log attempts without raw secrets ([security baseline](../governance/security-baseline.md)) |
