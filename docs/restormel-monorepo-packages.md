...
| `packages/contracts`, `packages/observability`, `packages/graph-reasoning-extensions` | `@restormel/contracts`, `@restormel/observability`, `@restormel/graph-reasoning-extensions` | **Phase 1 platform** — Zod contracts + trace/event shaping + reasoning graph extensions (compare, lineage, projection, …). Lifted from SOPHIA `packages/*`. Publish tag **`platform-v*`** → [`.github/workflows/publish-restormel-platform.yml`](../.github/workflows/publish-restormel-platform.yml) (order: contracts → observability → graph-reasoning-extensions). Phase 1 spec: [docs/restormel/phase1-restormel-engineering-spec.md](restormel/phase1-restormel-engineering-spec.md). |
