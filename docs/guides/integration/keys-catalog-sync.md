...
Schema: OpenAPI component **`ProjectModelsValidationError`**. The same shape is documented in the public integrator guide ([resolve-to-execution-contract.md](../resolve-to-execution-contract.md) — subsection *Project model index: response shape and validation errors*).
