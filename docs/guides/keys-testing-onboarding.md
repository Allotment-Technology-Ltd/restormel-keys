...
- Copy-ready `RESTORMEL_*` names consistent with [restormel-environment-vocabulary.md](restormel-environment-vocabulary.md).

Set at minimum (canonical names — see [restormel-environment-vocabulary.md](restormel-environment-vocabulary.md) § Testing runner):
...
- Hosted provider keys are a high-trust data class; see [security-baseline.md](../governance/security-baseline.md) and [threat-model-starter.md](../governance/threat-model-starter.md).

## Related

- Environment variable names: [restormel-environment-vocabulary.md](restormel-environment-vocabulary.md).
- Self-hosting the dashboard and Postgres: [guides/database-neon-for-self-hosters.md](database-neon-for-self-hosters.md) — [public page](https://restormel.dev/keys/docs/guides/database-neon-for-self-hosters).
