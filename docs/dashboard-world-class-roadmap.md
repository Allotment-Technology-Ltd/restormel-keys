...
every stage of [`verified-context-pivot-roadmap.md`](verified-context-pivot-roadmap.md) is ✅,
...
Identical to the [pivot roadmap protocol](verified-context-pivot-roadmap.md#delivery-protocol-how-we-run-this),
...
7. **The claims-ledger rule applies to UI copy (non-negotiable).** Any new dashboard copy
   ...
   [`verified-context-claims-ledger.md`](verified-context-claims-ledger.md) in the PR body.
...
### Stage W1.1 — Re-baseline `docs/ux-contracts.md`

*Resolves UX IA-2, IA-8, F-P1-3 (registry side). Files: `docs/ux-contracts.md` only.*

```
ROLE
Technical writer-engineer updating the dashboard's UX contract so every later stage in
docs/dashboard-world-class-roadmap.md can be graded against a true document. Docs only —
no code changes.
...
- docs/ux-contracts.md §2 (account-menu contract) and the
...
- docs/ux-contracts.md §3 ("Destructive actions: Require explicit user confirmation").
...
- docs/ux-contracts.md §3 (every error needs a recovery action).
...
- docs/ux-contracts.md §3 (loading/error/empty states for the versions list; publish and
...
- docs/ux-contracts.md §3 (recovery actions mandatory on every error/empty state).
...
- docs/verified-context-claims-ledger.md — rows 2, 9, 10 are the proven claims this UI
...
- docs/reviews/dashboard-functionality-review-2026-06.md §3 (scorecard row: "no
  public/share view of the public-shaped scorecard").
- docs/verified-context-claims-ledger.md — this stage is the claims-ledger rule
...
- .claude/skills/restormel-neu-brutalist-ui/SKILL.md and docs/design-system-index.md —
...
- docs/reviews/dashboard-ux-review-2026-06.md F-P1-3 (the drift roll-up: "Connect a
  ...
  behavior).
- docs/ux-contracts.md §2 (post-W1.1) — every rename cites its registry line.
...
- **The claims-ledger rule is standing** (protocol item 7): UI copy asserting verification
  ...
  [`verified-context-claims-ledger.md`](verified-context-claims-ledger.md); evidence
