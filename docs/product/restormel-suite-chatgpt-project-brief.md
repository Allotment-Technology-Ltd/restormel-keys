...
| Suite `platform/` split, npm tokens, deferred extractions | [`docs/architecture/platform-modularization.md`](../architecture/platform-modularization.md) |
| New module default stack (pnpm, SvelteKit, Vercel, Neon, Actions) | [`docs/architecture/restormel-module-default-stack.md`](../architecture/restormel-module-default-stack.md) |
| GitHub template + init script | [`docs/architecture/template-restormel-module-repo.md`](../architecture/template-restormel-module-repo.md) |
| Design system entry (tokens, alignment, drift checks) | [`docs/design/design-system-index.md`](../design/design-system-index.md) |
| Frozen CI/hosting snapshot (reference, not live config) | [`docs/architecture/platform-inventory.md`](../architecture/platform-inventory.md) |
| Security / redaction | [`docs/governance/security-baseline.md`](../governance/security-baseline.md) |
| Keys + Restormel Testing onboarding | [`docs/guides/keys-testing-onboarding.md`](../guides/keys-testing-onboarding.md) |
...
- `https://raw.githubusercontent.com/Allotment-Technology-Ltd/restormel-keys/main/docs/product/restormel-suite-chatgpt-project-brief.md` ← **this file**
- `https://raw.githubusercontent.com/Allotment-Technology-Ltd/restormel-keys/main/ARCHITECTURE.md`
- `https://raw.githubusercontent.com/Allotment-Technology-Ltd/restormel-keys/main/docs/architecture/platform-modularization.md`
- `https://raw.githubusercontent.com/Allotment-Technology-Ltd/restormel-keys/main/docs/architecture/restormel-module-default-stack.md`
...
```text
Treat docs/product/restormel-suite-chatgpt-project-brief.md as the suite orientation layer. For implementation detail, follow the canonical files it links to (especially ARCHITECTURE.md, platform-modularization.md, restormel-module-default-stack.md). Do not duplicate design token sources outside restormel-platform; do not commit secrets.
```
