...
TARGET
docs/product/verified-context-claims-ledger.md: a table where every public marketing claim maps
...
copy registry (docs/design/ux-contracts.md §2 — note the new Connect nouns).
...
- Every quality/verification claim on the page cites a row in
  docs/product/verified-context-claims-ledger.md with status "proven" — quote the row in the PR.
