---
title: Restormel Connect — product brief (Phase 0)
class: technical
owner: founder
status: approved
...
**Programme:** [SUITE-ARCHITECTURE-MIGRATION.md](../architecture/SUITE-ARCHITECTURE-MIGRATION.md)  
...
- [keys-routing-contract.md](../architecture/keys-routing-contract.md) — ingestion workload stages
- [database-neon-for-self-hosters.md](../guides/database-neon-for-self-hosters.md) — Neon + graph store pattern
- [THEME-L-IA-MATRIX.md](../architecture/THEME-L-IA-MATRIX.md) — marketing + dashboard IA
