...
**Canonical terminology:** [docs/design/ux-contracts.md](../design/ux-contracts.md) (copy registry). **Dashboard routes:** [apps/dashboard/README.md](../../apps/dashboard/README.md) and [apps/dashboard/src/lib/nav-config.ts](../../apps/dashboard/src/lib/nav-config.ts).
...
- **Restormel Testing:** Hub at `/keys/dashboard/testing` — auto-provisioned **Restormel Testing** project per workspace (dev/prod environments), model bindings seeded from connected providers; copy-ready `RESTORMEL_*` snippets. See [keys-testing-onboarding.md](../guides/keys-testing-onboarding.md).
