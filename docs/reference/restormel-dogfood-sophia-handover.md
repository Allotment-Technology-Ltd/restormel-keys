...
**Audience:** Operators on **SOPHIA** and **restormel-keys** preparing to validate the relay and upstream-notify automation.  
**Canonical policy:** [docs/github-dogfood-feedback.md](../github-dogfood-feedback.md).
...
- Existing **relay** secret and workflow remain as today.  
