# ARCHIVED (2026-03-17): Restormel Keys — Product Strategy

This document is archived for traceability. It reflects an older “hosted key storage / paste keys into Restormel” framing that is **not** the v1 default proposition.

For current truth, see:
- `STATUS.md`
- `ARCHITECTURE.md`
- `/keys/docs/guides/*` (published docs pages in the single SvelteKit app)
