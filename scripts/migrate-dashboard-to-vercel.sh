...
echo "    or https://restormel.dev/keys/dashboard/api/auth/callback/github for production."
echo ""
...
echo ""
echo "Step 4: (Obsolete.) Site and dashboard are on Vercel only; no Worker. Dashboard URL: https://restormel.dev/keys/dashboard."
echo ""
