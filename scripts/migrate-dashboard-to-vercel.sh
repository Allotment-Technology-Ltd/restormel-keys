...
echo "    BETTER_AUTH_SECRET    (e.g. openssl rand -base64 32)"
echo "    BETTER_AUTH_URL      (e.g. https://your-project.vercel.app/keys/dashboard)"
...
echo "    echo -n \"YOUR_VALUE\" | vercel env add BETTER_AUTH_SECRET production"
...
echo "  Set Authorization callback URL to:  {BETTER_AUTH_URL}/api/auth/callback/github"
echo "  e.g. https://your-project.vercel.app/keys/dashboard/api/auth/callback/github"
echo ""
