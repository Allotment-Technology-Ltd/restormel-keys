...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies__restormel_keys_svelte: string;
	export const VSCODE_NLS_CONFIG: string;
	export const HOMEBREW_PREFIX: string;
	export const CI: string;
	export const npm_package_dependencies__restormel_keys: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies__restormel_keys_svelte: string;
		VSCODE_NLS_CONFIG: string;
		HOMEBREW_PREFIX: string;
		CI: string;
		npm_package_dependencies__restormel_keys: string;
		LOGNAME: string;
