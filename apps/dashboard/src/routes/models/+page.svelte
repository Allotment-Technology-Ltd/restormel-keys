<script lang="ts">
  ...
  function applyFilters() {
    ...
    goto(`${base}/models${params.toString() ? "?" + params.toString() : ""}`);
  }
  ...
  function openDetail(id: string) {
    ...
    goto(`${base}/models?${params.toString()}`);
  }
...
{:else}
  ...
  {#if data.models.length === 0}
    ...
    >
      <a href={base + "/models"} class="btn btn-secondary">Clear filters</a>
    </EmptyState>
  {:else}
...
{#if selectedId}
  ...
  <aside class="drawer" role="dialog" aria-labelledby="drawer-title" aria-modal="true">
    ...
    <div class="drawer-body">
      <a href={base + "/models/" + selectedId} class="btn btn-secondary">Open full page</a>
