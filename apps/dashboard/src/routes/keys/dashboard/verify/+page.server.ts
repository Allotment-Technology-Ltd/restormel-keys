 ...
 * the M2 make-ready / stamping desk (claim triage + trust gates). With the flag OFF
 * this route does not exist (404) — preserving the pre-PR-G behaviour byte-for-byte,
 * so the supersede cut stays fully reversible. Query string preserved.
 */
