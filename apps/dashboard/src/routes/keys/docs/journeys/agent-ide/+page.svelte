...
<ol>
  ...
  <li>Use <a href="/keys/docs/integrations/aaif">AAIF</a> for typed request contracts where needed</li>
  <li>Check routing via dashboard logs and readiness endpoints</li>
</ol>
