...
// Renders the migrated legal record (legal/terms.md) at the original URL. Build-time gated:
// only served if the record is public + approved.
export const prerender = true;

export const load: PageServerLoad = () => {
  const rec = loadPublicRecordBySlug("terms");
