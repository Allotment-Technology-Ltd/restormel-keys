...
<svelte:head>
  <title>Restormel Founders Circle — Early access</title>
  <meta
    name="description"
    content="50 founding slots: 12 months Pro free, roadmap access, and a direct partnership with the Restormel team."
  />
</svelte:head>
...
<SuiteMarketingLayout>
  <article class="founders-page">
    <header class="founders-hero container">
      ...
      <p class="founders-hero-sub">50 slots. 12 months Pro free. Built with you, not just for you.</p>
    </header>

    <section id="program" class="section-prose container" aria-labelledby="program-heading">
      <h2 id="program-heading" class="section-h2">What the program is</h2>
      <p class="prose">
        The Founders Circle is a small, time-limited cohort for teams shipping AI products on top of Restormel. We’re
        opening <strong>50 seats</strong> so early adopters can run production workloads on Keys, Testing, and Graph
        with <strong>12 months of Pro access included</strong> — while we tune the suite around real usage.
      </p>
      <p class="prose">
        This isn’t a passive discount code. Founders get a direct line to roadmap prioritisation, candid feature previews,
        and a partnership mindset: your feedback shapes what we build next.
      </p>
    </section>
      ...
      <div class="container">
        ...
        <ul class="benefits-grid">
          <li class="benefit-card">
            <h3 class="benefit-title">12 months Pro</h3>
            <p class="benefit-text">Full Pro entitlements on the modules you choose — no card required for the founding year.</p>
          </li>
          <li class="benefit-card">
            <h3 class="benefit-title">Roadmap access</h3>
            <p class="benefit-text">Visibility into what’s shipping, what’s deferred, and why — before it hits the public changelog.</p>
          </li>
          <li class="benefit-card">
            <h3 class="benefit-title">Direct channel</h3>
            <p class="benefit-text">A short feedback loop with the team building the product, not a ticket black hole.</p>
          </li>
          <li class="benefit-card">
            <h3 class="benefit-title">Early features</h3>
            <p class="benefit-text">First access to hosted Pro surfaces (run history, regression views, Platform bundle) as they graduate from dogfood.</p>
          </li>
        </ul>
      </div>
    </section>
    ...
    <section class="section-ask container" aria-labelledby="ask-heading">
      ...
      <p class="prose intro-ask">
        We’re asking for a fair exchange: your honest experience in exchange for generous terms. Concretely:
      </p>
      <ol class="ask-list">
        <li>
          <strong>One structured feedback session</strong> — a video or async walkthrough of how Restormel fits your stack,
          what works, and what hurts.
        </li>
        <li>
          <strong>One public signal</strong> — a GitHub star, a short social post, or a logo on our site; you pick the format
          that fits your brand.
        </li>
        <li>
          <strong>Optional case study</strong> — if you’re willing, a lightweight write-up we can share (anonymised or
          attributed — your call).
        </li>
      </ol>
    </section>
    ...
    <section class="section-form section-alt" aria-labelledby="apply-heading">
      <div class="container form-wrap">
        <h2 id="apply-heading" class="section-h2">Apply</h2>

        {#if submitted}
          <div class="form-success" role="status">
            <h3 class="form-success-title">Thank you</h3>
            <p class="form-success-copy">
              We’ve received your application. If your profile fits the current cohort, we’ll email you within a few
        ...
        {:else}
          ...
          <form class="founders-form" method="POST" use:enhance>
            ...
            <div class="form-actions">
              <button type="submit" class="btn btn-primary btn-submit">Apply for founding access</button>
            </div>
            <p class="form-privacy">
              By applying you agree we may contact you about the program. We don’t sell your data.
              <!-- Webhook: set FOUNDERS_APPLICATION_WEBHOOK_URL to receive JSON payloads server-side. -->
            </p>
          </form>
        {/if}
      </div>
