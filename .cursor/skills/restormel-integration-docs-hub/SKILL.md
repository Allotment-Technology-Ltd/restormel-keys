...
- [docs/keys-routing-contract.md](../../../docs/keys-routing-contract.md) — routing + AAIF `integrationStack` narrative.
...
4. **One canonical owner:** If policy overlaps design vs docs, link from [docs/design-system-index.md](../../../docs/design-system-index.md) to the guide—do not duplicate trademark law in multiple places.
