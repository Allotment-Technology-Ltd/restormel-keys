...
- Public legal/privacy text (sub-processors, RoPA-derived notices) goes live **with or just before** the
  processing it describes — never ahead of it (see [[restormel-isms-governance]]).
...
## Related
- Build-ahead delivery: [[restormel-swarm-delivery]]. Governance records: [[restormel-isms-governance]].
