...
- **Records keep themselves current** — stage governance updates in the same PR ([[restormel-isms-governance]]).
...
governance (Opus/Sonnet, [[restormel-isms-governance]]). Add domain agents (e.g. [[restormel-email-engineering]])
per the work.
