...
description: >-
  ...
  another agent. Pairs with restormel-infra-alert-response (alerts), restormel-dr-recovery (BX11/restic),
  restormel-isms-governance (the mandatory incident record), and restormel-k3s-architecture (target design).
---
...
**Always, regardless of severity:** file an incident record immediately via **`restormel-isms-governance`**
...
- File the recovery as evidence (posture record) via `restormel-isms-governance` — the achieved RTO updates
...
- Target architecture: `restormel-k3s-architecture` · backups/restic + BX11: `restormel-dr-recovery`.
- Alerts → cause/first-action: `restormel-infra-alert-response` · records: `restormel-isms-governance`.
